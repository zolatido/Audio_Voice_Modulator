...
def blossom_voice_effect(input_filename, output_filename):
    # Load the input audio file
    audio_data, sample_rate = sf.read(input_filename)

    # Adjust pitch and speed
    pitch_shift_factor = 1.64  # Higher mas matinis
    speed_factor = 0.9       # Mas mataas nagiging medyo normal na yung voice bumabagal din
...
if __name__ == "__main__":
    ...
    # Apply then save
    blossom_voice_effect(input_filename, output_filename)
