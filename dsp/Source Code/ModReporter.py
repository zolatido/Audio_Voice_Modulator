...
def zombie_voice_effect(input_filename, output_filename):
    # Load the input audio file
    audio_data, sample_rate = sf.read(input_filename)

    # Adjust pitch and speed
    pitch_shift_factor = 0.5  # Higher mas matinis
...
if __name__ == "__main__":
    ...
    # Apply then save
    zombie_voice_effect(input_filename, output_filename)
